    ...
    <tr>
      <td><p style="text-align: center; display: block;  padding-bottom:20px;  margin-bottom:20px; border-bottom:1px solid #dddddd;">
        ...
        <h2 style="font-weight: 200; font-size: 16px; margin: 20px 0; color: #333333;">
          Email: {{ $data['email'] }} </h2>
        <h2 style="font-weight: 200; font-size: 16px; margin: 20px 0; color: #333333;">
          Subject: {{ $data['title'] }} </h2>
        <h2 style="font-weight: 200; font-size: 16px; margin: 20px 0; color: #333333;">
          Message: {{ $data['message'] }} </h2>
        <p style="text-align: center; display: block; padding-top:20px; font-weight: bold; margin-top:30px; color: #666666; border-top:1px solid #dddddd;">SKIPTOTRACE</p></td>
      </tr>
    </table>
</div>
</td>
